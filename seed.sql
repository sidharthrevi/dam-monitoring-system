...
USE dam_monitoring;
UPDATE users SET password_hash = '$2b$10$vuf65eas0yI/rZrxgdH2tuzx4LToodstOuIUoL4x.MBO7BkGzfnfO' WHERE username = 'admin01';
UPDATE users SET password_hash = '$2b$10$u0BtBAynvbNBHQ8EJLnp6OQ5v61dwZhcVPGdJ7WWUOEwBK.0OjZNO' WHERE username = 'operator01';
UPDATE users SET password_hash = '$2b$10$ndxHS.sK9KllYBrBcO3Xfe4hSiyia1nD5MgWB.wGNnikSazXITe1m' WHERE username = 'viewer01';

USE dam_monitoring;
SELECT id, dam_id, date, water_level, alert_level FROM dam_readings ORDER BY dam_id, date;